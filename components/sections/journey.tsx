...
const journeySteps = [
  ...
  },
  {
    year: "2023",
    title: "Career Growth",
    description: "Joined Lal10 as SDE-I, working on enterprise applications and mobile development",
    icon: Rocket,
  ...
  },
  {
    ...
    description: "Expanding expertise in full-stack development, cloud services, and mobile development",
    icon: Code2,
