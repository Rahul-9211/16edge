        ...
        <div className="container px-4 mx-auto">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {services.map((service, index) => (
              ...
              >
                <Card className="h-full group hover:shadow-xl transition-shadow bg-white dark:bg-white border-primary/20 cursor-pointer" id={service.title.toLowerCase().replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, '')}>
